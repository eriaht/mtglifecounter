  ...
  return (
    <svg width="50px" height="50px" viewBox="0 0 28 28" version="1.1">
      ...
      <g
        ...
        fill-rule="evenodd"
      >
        <g id="ic_fluent_people_28_filled" fill="#fff" fill-rule="nonzero">
          <path
    ...
    >
      <g>
        <g>
          <g>
            <path
              d="M467.213,153.636c-5.146-10.599-17.91-15.018-28.509-9.872c-10.599,5.147-15.018,17.911-9.872,28.509
            ...
            />
            <path
              d="M63.999,255.991c0-106.028,85.966-192,192-192c29.263,0,58.057,7.558,84.412,21.342h-20.416
